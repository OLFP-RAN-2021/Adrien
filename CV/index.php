                ...
                <div>
                    <form action="includes/API/form.php" class="form-fetch" method="post">
                        <fieldset>
                            ...
                            <span class="regex hidden">^[\w.-]*@[\w.-]*\.[\w.]{2,}$</span>
                            <label class="mssg h idden" id="email-mssg">
                        ...
                        <fieldset>
                            ...
                            <span class="regex hidden">[\w .-]{5,}</span>
                            <label class="mssg hidden" id="subject-mssg">
                        ...
                        <fieldset>
                            ...
                            <span class="regex hidden">.{50,}</span>
                            <label class="mssg hidden" id="content-mssg">
